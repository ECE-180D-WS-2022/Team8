...
icons =pygame.image.load('images/icons.png')
icons = pygame.transform.scale(icons, (1200/2, 900/2))
...
def stir():
    for i in range(1,115):
       ...
       # print('it:'+str(it))
        ...
        x = round(i/115*10)
        for t in range(0,x):
            pygame.draw.rect(screen, green, pygame.Rect(349+(50*t), 821, 48, 28) )
...
def chop():
    for i in range(1,28):
       # print('it:'+str(it))
        ...
        var_name1 = "c"+str(i)
        screen.blit(globals()[var_name1], (200, 110))
		#increment progress bar
        if (i%3==0):
            chop_Sound = mixer.Sound('sounds/cut.wav')
            chop_Sound.play()
        pygame.draw.rect(screen, black, pygame.Rect(349, 720, 500, 30),2 )
        #increment progress bars
        screen.blit(icons, (10,10))
        x = round(i/27*10)
        for t in range(0,x):
